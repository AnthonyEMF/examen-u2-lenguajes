...
namespace ExamenLenguajes2.API.Database
{
	public class Examen2Seeder
	{
		...
		public static async Task LoadAccountsAsync(Examen2Context context, ILoggerFactory loggerFactory)
		{
			try
			{
		...
		public static async Task LoadTransactionsAsync(Examen2Context context, ILoggerFactory loggerFactory)
		{
			try
			{
		...
		public static async Task LoadEntriesAsync(Examen2Context context, ILoggerFactory loggerFactory)
		{
			try
			{
		...
		public static async Task LoadBalancesAsync(Examen2Context context, ILoggerFactory loggerFactory)
		{
			try
			{
